...
const DEFAULT_HAND_PROFILE_PATH = '../generic-hand/';

/**
 * Represents one of the generic-hand model types {@link XRHandModelFactory} might produce
 * depending on the selected profile. `XRHandMeshModel` represents a generic-hand with a
 * custom asset.
 *
...
class XRHandMeshModel {
	...
	/**
	 * Constructs a new XR generic-hand mesh model.
	 *
	 * @param {XRHandModel} handModel - The generic-hand model.
